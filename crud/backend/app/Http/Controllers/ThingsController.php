...
class ThingsController extends Controller
{
    ...
    /**
     * Display a listing of all the resources without restriction
     */
    public function resources() {
        return Things::with('user')->where('status', 'active')->get();
        // return $user->things()->where('status', 'active')->get();
    }
    ...
    /**
     * Display all resources for a specified resource.
     */
    public function show_one(Request $request, $id) {
        $things = Things::where('user_id', $id)->where('status', 'active')->get();
